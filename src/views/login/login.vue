	...
	<div class="container">
		...
		<section class="wb100 dis-ib conTop">
		    <div class="loginTop">
		        ...
		        <span @click="$router.push('/reg')" class="loginHref"><img src='/static/images/icon-17.png'><em>注册</em></span>
		    </div>
		    <div class="loginList">
		        <ul :model="formData">
		            <li>
		                <input type="text" v-model="formData.accountNo" placeholder="请输入手机号">
		            </li>
		            <li>
